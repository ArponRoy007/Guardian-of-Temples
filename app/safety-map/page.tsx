      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-950 to-primary-950/50 p-6 sm:p-10 border border-slate-800 text-white shadow-2xl">
        <div className="relative z-10 max-w-3xl space-y-4">
          ...
          <p className="text-sm sm:text-base text-slate-300 leading-relaxed max-w-2xl">
            বাংলাদেশের ৬৪ জেলা জুড়ে মন্দির-সংক্রান্ত যাচাইকৃত তথ্য একত্রিত
            করে জনসচেতনতা বৃদ্ধি এবং সংশ্লিষ্ট কর্তৃপক্ষকে সহায়তা করার লক্ষ্যে
            এই মানচিত্র তৈরি করা হয়েছে — একটি স্বচ্ছ ও দায়িত্বশীল কমিউনিটি
            উদ্যোগ হিসেবে।
          </p>
